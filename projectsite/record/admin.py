...
class ProfessorAdmin(admin.ModelAdmin):
    list_display = ("FirstName", "LastName", "Email", "Department")
    search_fields = ("FirstName", "LastName", "Email", "Department")

@admin.register(Course)
class CourseAdmin(admin.ModelAdmin):
    list_display = ("CourseName", "Department", "ProfessorID")
...
class AssignmentAdmin(admin.ModelAdmin):
    list_display = ("AssignmentName", "Deadline", "CourseID")
    search_fields = ("AssignmentName", "CourseID__CourseName")

@admin.register(Grade)
class GradeAdmin(admin.ModelAdmin):
    list_display = ("StudentID", "AssignmentID", "Score")
